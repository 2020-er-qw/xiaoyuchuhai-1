...
const i18nData = {
        ...
        "post_pdf_cta_btn": "前往 PDF 工具",
				...
				//converter
				"conv_guide_title": "如何在本地将 HEIC 和 WebP 转换为 JPG",
				"conv_why_heic_t": "为什么要将 HEIC 转换为 JPG？",
				"conv_why_heic_d": "HEIC 是 iPhone 的默认格式，但许多 Windows 和安卓应用不支持。我们的工具将其转换为高质量 JPG，以便您在任何地方查看。",
				"conv_privacy_t": "在线转换安全吗？",
				"conv_privacy_d": "大多数转换器会将您的照片上传到服务器。SwiftConvert 不同：所有处理都在您的浏览器中完成。您的私密照片永不离开您的设备。",
				"conv_steps_title": "简单 3 步完成转换",
				"conv_step_1": "将 HEIC 或 WebP 文件拖入上方的方框中。",
				"conv_step_2": "转换过程将在您的浏览器内存中自动开始。",
				"conv_step_3": "点击“下载全部”即可立即保存您的 JPG 文件。",
...
"cat_pdf": "PDF Tools",
        ...
        "post_pdf_cta_btn": "Go to PDF Tools",
				...
				//converter
				"conv_guide_title": "How to Convert HEIC and WebP to JPG Locally",
				"conv_why_heic_t": "Why convert HEIC to JPG?",
				"conv_why_heic_d": "HEIC is the default format for iPhones, but many Windows and Android apps don't support it. Our tool converts them to high-quality JPGs so you can view them anywhere.",
				"conv_privacy_t": "Is it safe to convert online?",
				"conv_privacy_d": "Most converters upload your photos to their servers. SwiftConvert is different: all processing happens in your browser. Your private photos never leave your device.",
				"conv_steps_title": "3 Simple Steps to Convert",
				"conv_step_1": "Drag and drop your HEIC or WebP files into the box above.",
				"conv_step_2": "The conversion starts automatically in your browser's RAM.",
				"conv_step_3": "Click \"Download All\" to save your JPG files instantly.",
